...
REGION="europe-west1"
SERVICE_NAME="factory-ai-agent-business-mcp-server"
SERVICE_ACCOUNT_NAME="factory-business-mcp-sa"
...
deploy_cloud_run() {
    ...
    ENV_VARS="GOOGLE_MAPS_API_KEY=${GOOGLE_MAPS_API_KEY},API_KEY_TARGETARE=${API_KEY_TARGETARE},GOOGLE_CUSTOM_SEARCH_API_KEY=${GOOGLE_CUSTOM_SEARCH_API_KEY},GOOGLE_CUSTOM_SEARCH_CX=${GOOGLE_CUSTOM_SEARCH_CX},PROJECT_ID=${PROJECT_ID},GEMINI_API_KEY=${GEMINI_API_KEY}"
