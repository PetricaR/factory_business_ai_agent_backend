...
REGION="europe-west1"
SERVICE_NAME="factory-ai-agent-maps-mcp-server"
SERVICE_ACCOUNT_NAME="factory-maps-mcp-sa"
...
validate_prerequisites() {
    ...
    if [ ! -f "maps-mcp-server.py" ]; then
        log_error "maps-mcp-server.py not found in current directory"
        exit 1
    fi
    log_success "maps-mcp-server.py found"
