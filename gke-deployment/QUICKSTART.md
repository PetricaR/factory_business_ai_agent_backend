...
agent-factory-ai   1/1     1            1           5m

Pods:
NAME                                READY   STATUS    RESTARTS   AGE
agent-factory-ai-67878554b4-hc68s   1/1     Running   0          5m

Service:
NAME               TYPE           CLUSTER-IP      EXTERNAL-IP   PORT(S)        AGE
agent-factory-ai   LoadBalancer   34.118.234.248  34.7.227.11   80:32499/TCP   5m
...
gcloud iam service-accounts delete \
  agent-factory-ai-sa@$GCP_PROJECT_ID.iam.gserviceaccount.com
```
