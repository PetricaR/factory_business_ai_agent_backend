...
export APP_NAME="agent-factory-ai"         # Name of your app
...
kubectl create deployment agent-factory-ai \
  --image=gcr.io/PROJECT/agent-factory-ai:latest

# Expose as LoadBalancer
kubectl expose deployment agent-factory-ai \
  --type=LoadBalancer \
  --port=80 \
  --target-port=8080
```
